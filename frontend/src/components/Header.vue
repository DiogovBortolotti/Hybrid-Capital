<template>
  <!-- Placeholder enquanto checa login -->
  <div v-if="!isAuthChecked">
    <header class="header">
      <div class="header-container">
        <div class="logo-container animate-pulse">
          <div class="icon bg-[#a79de9] rounded-full w-8 h-8"></div>
  ...
  <header v-else-if="!isLoggedIn" class="header">
    <div class="header-container">
    ...
    <div class="header-container">
      ...
      <div class="flex items-center space-x-6">
          ...
          <div
                ...
                <div v-for="notification in notifications" :key="notification.id"
                  ...
                  <div class="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-[#615c8e] mt-1">{{ formatDate(notification.date) }}</p>
                    </div>
                  </div>
                </div>
              </template>
            ...
            <div v-if="notifications.length > 0"
              ...
              <button @click="markAllAsRead"
                class="text-sm text-[#615c8e] hover:text-[#a79de9]">
        ...
        <details class="relative group">
          ...
          <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg text-[#120907] z-50">
            <div class="py-1">
              <a href="#" @click.prevent="$router.push('/home-painel')"
                class="block px-4 py-2 hover:bg-[#eed4ed] flex items-center space-x-2">
                <span class="material-symbols-outlined text-sm">home</span>
                <span>Dash Finanças</span>
              </a>
              <a href="#" @click.prevent="$router.push('/lancamento')"
                class="block px-4 py-2 hover:bg-[#eed4ed] flex items-center space-x-2">
                <span class="material-symbols-outlined text-sm">receipt</span>
                <span>Lançamentos</span>
              </a>
              <a href="#" @click.prevent="$router.push('/pagamentos')"
                class="block px-4 py-2 hover:bg-[#eed4ed] flex items-center space-x-2">
                <span class="material-symbols-outlined text-sm">analytics</span>
        ...
        <details class="relative group">
          ...
          <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg text-[#120907] z-[1000]">
            <div class="py-1">
              <a href="#" @click.prevent="$router.push('/friendList')"
                class="block px-4 py-2 hover:bg-[#eed4ed] flex items-center space-x-2">
              ...
              <button @click="logout"
                class="block w-full px-4 py-2 hover:bg-[#eed4ed] flex items-center space-x-2 text-left">
